...
(function() {
  ...
  function render(container, year) {
    ...
    Promise.all(years.map(y =>
      fetch('data/culture_classification' + window.yearSuffix(y) + '.json')
  ...
  function doRender(container, data, year, other, otherYear) {
    ...
    stats.innerHTML = `
      <div class="sports-stat">
        ...
        <div class="sports-stat-lbl">total identifié comme culture (${meta.pct_chf_precisely_classified}% du secteur)</div>
      </div>
      <div class="sports-stat">

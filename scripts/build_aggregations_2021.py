...
json.dump(out, open(OUT / 'top30_beneficiaires_2021.json', 'w', encoding='utf-8'), indent=2, ensure_ascii=False)
...
json.dump(out, open(OUT / 'top20_villes_2021.json', 'w', encoding='utf-8'), indent=2, ensure_ascii=False)
...
json.dump(out, open(OUT / 'treemap_canton_secteur_2021.json', 'w', encoding='utf-8'), indent=2, ensure_ascii=False)
...
json.dump(out, open(OUT / 'per_capita_2021.json', 'w', encoding='utf-8'), indent=2, ensure_ascii=False)

...
ba.INPUT = ROOT / 'docs' / 'data' / 'brb2023_full.json'
...
json.dump(out, open(OUT / 'top30_beneficiaires_2023.json', 'w'), indent=2, ensure_ascii=False)
...
json.dump(out, open(OUT / 'top20_villes_2023.json', 'w'), indent=2, ensure_ascii=False)
...
json.dump(out, open(OUT / 'treemap_canton_secteur_2023.json', 'w'), indent=2, ensure_ascii=False)
...
json.dump(out, open(OUT / 'per_capita_2023.json', 'w'), indent=2, ensure_ascii=False)

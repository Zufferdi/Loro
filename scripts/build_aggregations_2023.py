#!/usr/bin/env python3
"""build_aggregations_2023.py — version 2023 du builder d'agrégations.
Génère top30/villes/treemap/per_capita avec suffixe _2023 depuis brb2023_full.json.
"""
...
# Reproduce the 4 aggregations with _2023 suffix
# Top 30
...
out = {
    '_meta': {'description': 'Top 30 (2023)', 'method': 'normalized', 'top30_total_chf': top30_total, 'top30_pct_of_brb': round(100*top30_total/total_all, 1)},
    'beneficiaires': top30
}
json.dump(out, open(OUT / 'top30_beneficiaires_2023.json', 'w', encoding='utf-8'), indent=2, ensure_ascii=False)
print(f"✓ top30_beneficiaires_2023.json")
...
out = {'_meta': {'description': 'Top 20 villes (2023)', 'method': 'group by ville', 'top20_total_chf': villes_total}, 'villes': villes}
json.dump(out, open(OUT / 'top20_villes_2023.json', 'w', encoding='utf-8'), indent=2, ensure_ascii=False)
print(f"✓ top20_villes_2023.json")
...
out = {'_meta': {'description': 'Treemap canton×secteur (2023)'}, 'cantons': cantons_out}
json.dump(out, open(OUT / 'treemap_canton_secteur_2023.json', 'w', encoding='utf-8'), indent=2, ensure_ascii=False)
print(f"✓ treemap_canton_secteur_2023.json")
...
out = {'_meta': {'description': 'CHF par habitant (2023)'}, 'cantons': out_pc}
json.dump(out, open(OUT / 'per_capita_2023.json', 'w', encoding='utf-8'), indent=2, ensure_ascii=False)
print(f"✓ per_capita_2023.json")

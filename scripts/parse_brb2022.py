#!/usr/bin/env python3
"""
parse_brb2022_v3.py — Use ville→canton mapping + sector headers
================================================================
...
INPUT = Path(sys.argv[1]) if len(sys.argv) > 1 else Path('/mnt/user-data/uploads/BRB2022.md')
OUTPUT = ROOT / 'docs' / 'data' / 'brb2022_full.json'
...
def main():
    ...
    OUTPUT.write_text(json.dumps({
        '_meta': {
            'source': 'BRB2022.pdf (ra.loro.ch/documents/BRB2022.pdf)',
            'parsed_from': 'BRB2022.md',
            'annee': 2022,

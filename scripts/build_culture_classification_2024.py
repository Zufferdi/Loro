...
Output: docs/data/culture_classification_2024.json
"""
import json
import re
...
OUTPUT = ROOT / 'docs' / 'data' / 'culture_classification_2024.json'
...
def main():
    ...
    out = {
        '_meta': {
            'source': 'docs/data/brb2024_full.json (v15.0 GE/JU/SR extracted)',
